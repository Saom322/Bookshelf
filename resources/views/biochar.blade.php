                                    ...
                                    <div class="booksmedia-detail-box">
                                        <div class="single-book-box">                                                
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="Book" src="/images/biochar.jpg" />                                                    
                                            </div>
                                            <div class="post-detail">
                                            
                                                
                                                <header class="entry-header">
                                                    <h2 class="entry-title">The Biochar Revolution</h2>
                                                    <ul>
                                                        <li><strong>Author: </strong> Paul Taylor (Author, Editor), Hugh McLaughlin (Author), Tim Flannery (Foreword)</li>
                                                        <!--<li><strong>ISBN:</strong> 0593188713 (ISBN13: 9780593188712)</li>-->
                                                        
                                                        <li><strong>Edition: </strong> First edition</li>
                                                        
                                                        <li><strong>Published: </strong>December 1st 2010 by Global Publishing Group</li>
                                                        <li><strong>Length: </strong> 377 pages.</li>
                                            <li><strong>Language: </strong>English</li>
                                            <li><strong>Genre: </strong> Revolution, Environment</li>
                                                    </ul>
                                                </header>
                                        ...
                                        <p><strong>Summary:</strong> A friendly, informative, inspiring and break-through reference guide for anyone interested in biochar or concerned about environmental issues.<br>

This book has contributions from 18 biochar experts and authors.<br>

You'll Discover<br>
Ancient Solutions to Modern Problems<br>
How to Produce Biochar<br>
How to Test and Use Biochar<br>
How to Change the World with Biochar<br>
The Financial Benefits of Biochar<br>
How to Garden and Farm with Biochar<br>
...
People who want to do something about climate change<br>
Waste management districts, foresters, councils, government agencies<br>
Policy makers in Australia, NZ, US, UK, and other developed and undeveloped countries</p>
