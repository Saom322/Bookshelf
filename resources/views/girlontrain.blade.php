                                    ...
                                    <div class="booksmedia-detail-box">
                                        <div class="single-book-box">                                                
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="Book" src="/images/girlOn.jpg" />                                                    
                                            </div>
                                            <div class="post-detail">
                                            
                                                
                                                <header class="entry-header">
                                                    <h2 class="entry-title">The Girl on The Train</h2>
                                                    <ul>
                                                        <li><strong>Author:</strong> Paula Hawkins</li>
                                                        <li><strong>ISBN:</strong>1594633665 (ISBN13: 9781594633669)</li>
                                                        
                                                        <li><strong>Edition:</strong> First edition</li>
                                                        <li><strong>Published:</strong> January 13th 2015 by Riverhead Books (first published January 6th 2015)</li>
                                                        <li><strong>Length:</strong> 325 pages.</li>
                                           <!-- <li><strong>Format:</strong> DVD</li>-->
                                            ...
                                            <li><strong>Genre :</strong> Thriller</li>
                                                ...
                                                <div class="entry-content post-buttons">
                                                    <a href="#." class="btn btn-dark-gray">Offer this book</a>
                                                    <a href="#." class="btn btn-dark-gray">Add to Wishlist</a>
                                                    
                                                </div>
                                            </div>
                                        </div>
                                        <p><strong>Summary:</strong>Rachel catches the same commuter train every morning. She knows it will wait at the same signal each time, overlooking a row of back gardens. She’s even started to feel like she knows the people who live in one of the houses. “Jess and Jason,” she calls them. Their life—as she sees it—is perfect. If only Rachel could be that happy. And then she sees something shocking. It’s only a minute until the train moves on, but it’s enough. Now everything’s changed. Now Rachel has a chance to become a part of the lives she’s only watched from afar. Now they’ll see; she’s much more than just the girl on the train...</p>
