                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="topbar-info">
                                                <a href="+880-1777-111111">+880-1777-111111</a>
                                                <span>/</span>
                                                <a href="mailto:support@bookshelf.com">support@bookshelf.com</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                <a href="/signup"><i class="fa fa-lock"></i>Login / Register</a>
                                                <span>|</span>
        ...
        <div data-ride="carousel" class="carousel slide" id="home-v1-header-carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <figure>
                        <img alt="Home Slide" src="/images/header-slide.jpg" />
                    </figure>
                    <div class="container">
                        <div class="carousel-caption">
                            <h3>Read and Share Books Anytime, Anywhere!</h3>
                            <h2>Discover Your Books</h2>
                            <p>More than a book store.</p>
                ...
                <div class="item">
                    <figure>
                        <img alt="Home Slide" src="/images/header-slide-2.jpg" />
                    </figure>
                    <div class="container">
                        <div class="carousel-caption">
                            <h3>Share Your Old Books!</h3>
                ...
                <div class="item">
                    <figure>
                        <img alt="Home Slide" src="/images/header3.jpg" />
                    </figure>
                    <div class="container">
                        <div class="carousel-caption">
                            <h3>Grab a Book Anytime!</h3>
                    ...
                    <div class="col-md-6">
                        <div class="welcome-wrap">
                            <div class="welcome-text">
                                <h2 class="section-title">Welcome to the Bookshelf</h2>
                                <span class="underline left"></span>
                                <p class="lead">More Than A Book Store.</p>
                                <p>Our Bookshelf is a plartform that you can exchange your books with others through our site.You can buy  books from our site.And also donate your old books to find any books from another doner.You can make profile,give your valuable reviews through our site. We assure you to make a easy solution of finding the book doner,and contacting with them in an easy method.Bookshelf is a endeavour of four book-lovers as well as reading enthusiasts who welcomes all people who love to read books and explore. It is a sharing platform for those who wants to read and share their knowledge and reviews regarding books including offers their books physically to help other people who shares the same passion for reading.Developers of this site are four new to web development world CSE students of Jagangirnagar University </p>
