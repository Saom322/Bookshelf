                                    ...
                                    <div class="booksmedia-detail-box">
                                        <div class="single-book-box">                                                
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="Book" src="/images/mongolia.jpg" />                                                    
                                            </div>
                                            <div class="post-detail">
                                            
                                                
                                                <header class="entry-header">
                                                    <h2 class="entry-title">Mongolia</h2>
                                                    <ul>
                                                        <li><strong>Author: </strong>  Liza F. Carter</li>
                                                        <!--<li><strong>ISBN:</strong> 0593188713 (ISBN13: 9780593188712)</li>-->
                                                        
                                                        <li><strong>Edition: </strong> First edition</li>
                                                        
                                                        
                                                        <li><strong>Published: </strong> September 2002 by Scribner</li>
                                                        <li><strong>Length: </strong> 500 pages.</li>
                                            <li><strong>Language: </strong>English</li>
                                            <li><strong>Genre: </strong> Family Story,History</li>
                                                    </ul>
                                                </header>
