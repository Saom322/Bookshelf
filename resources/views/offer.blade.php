        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">Share Books and Build a Community. </p>
                </div>
                                ...
                                <div class="row">
                                    <div class="contact-area">
                                        <div class="container">
                                            ...
                                            <div class="col-md-10 border-gray-right">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="contact-form bg-light margin-right">
                                                            <h2>Offer Your Books for Building Readers Community</h2>
                                                            <span class="underline left"></span>
                                                            <div class="contact-fields">
                                                                <form  name="contact" action="addbook" method="POST" >
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Your Name" name="User" id="first-name" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Book Title" name="Name" id="title" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                         <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Book Author" name="Author" id="author" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Edition" name="Edition" id="edition" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Published" name="Published" id="published" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                        
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Page Number" name="Page" id="length" size="20" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>  
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Language" name="Language" id="language" size="20" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Description" name="Genre" id="genre" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                    
                                                                        <div c  lass="col-sm-12">
                                                                            <div class="form-group">
                                                                                <textarea class="form-control" placeholder="Book Review" name="Summary" aria-required="true"></textarea>
                                                                                <div class="clearfix"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group form-submit">
                                                                            <button type="submit"class="btn btn-success" name="action" value="add">Add Offer</button>
                                                                            </div>
        ...
        <section class="social-network section-padding">
            <div class="container">
                <div class="center-content">
                    ...
                    <span class="underline center"></span>
                    <p class="lead">You can follow us through these sites.</p>
                </div>
                <ul>
                    <li>
