        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">Review can give positivity </p>
                </div>
        ...
        <section class="search-filters">
            <div class="container">
                <div class="filter-box">
                    <h3>Searching For a Book Review ?</h3>
                    <form name="searchreview" action="searchreview" method="POST"  >
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="contact-form bg-light margin-right">
                                                            ...
                                                            <div class="contact-fields">
                                                                <form  name="contact" action="addreview" method="POST" >
                                                                    @csrf
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 col-sm-6">
                                                                         ...
                                                                         <div class="col-md-6 col-sm-6">
                                                                            <div class="form-group">
                                                                                <input class="form-control" type="text" placeholder="Book Name" name="Name" id="book" size="30" value="" aria-required="true" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group">
                                                                                <textarea class="form-control" placeholder="Your Review" name="Review" aria-required="true"></textarea>
                                                                                <div class="clearfix"></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group form-submit">
                                                                            <button type="submit"class="btn btn-success" name="action" value="add">Add Review</button>
