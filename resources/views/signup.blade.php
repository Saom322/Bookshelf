    ...
    <body>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="topbar-info">
                                                <a href="tel:+880-1777-111111"></i>+880-1777-111111</a>
                                                <span>|</span>
                                                <a href="mailto:support@bookshelf.com"></i>support@bookshelf.com</a>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="nav">
                                       ...
                                       <!--  <li> --><!-- 
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li style="color:white;"><a href="/gview">Books &amp; Media Grid View</a></li>
                                       ...
                                       <!--  <li class="dropdown">
                                        ...
                                        <li style="color:white;"><a href="/service">Review</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="company-detail bg-dark margin-left">
                                                        ...
                                                        <form name="signin" class="login" action="getdata" method="POST">
                                                        @csrf
                                                            <p >
                                                                <label>
                                                                <input type="text" name="Name" placeholder="User Name" size="50"/>
                                                                </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="company-detail new-account bg-light margin-right">
                                                        ...
                                                        <form name="signup" action="adddata" class="login" method="POST" onsubmit="req()">
                                                        @csrf
                                                            <p>
                                                            <label>
                                                                <input type="text" name="Name" placeholder="Name" size="100" />
                                                                </label>
                                                            </p>
                                                            <p >
                                                                <label>
                                                            ...
                                                            <p >
                                                                <label>
                                                                <input type="text" name="Contact" placeholder="Contact Number" size="100" />
                                                                </label>
                                                            </p> 
                                                            <p >
                                                                <label>
                                                                <input type="password" name="Password" placeholder="Password" size="100" />
                                                                </label>
                                                            </p>
                                                            <p >
                                                                <label>
                                                                <input type="password" name="Confirmpass" placeholder="Confirm Password" size="100" />
                                                                </label>
                                                            </p>                                                                                    
                                                            <div class="clear"></div>
                                                            <input type="submit" value="Signup" name="signup" >
                                                            <!-- <button type="submit" class="button btn btn-default">Search</button> -->
                                                            <div class="clear"></div>
                                                        </form> 
                                                    </div>
                                                </div>
        ...
        <script>
            function req()
            {
                ...
                var f=document.forms["signup"]["Confirmpass"].value;
                if(e!=f)
                {
                    alert ("Password Don't Match");
                    return false;
                }
                else{alert ("A welcome Mail has been sent to your Mailbox");
                    return true;}
            }
        </script>
