                                    ...
                                    <div class="booksmedia-detail-box">
                                        <div class="single-book-box">                                                
                                            <div class="post-thumbnail">
                                                ...
                                                <img alt="Book" src="/images/wool.jpg" />                                                    
                                            </div>
                                            <div class="post-detail">
                                            
                                                
                                                <header class="entry-header">
                                                    <h2 class="entry-title">Wool</h2>
                                                    <ul>
                                                        <li><strong>Author: </strong> Hugh Howey</li>
                                                        <!--<li><strong>ISBN:</strong> 0593188713 (ISBN13: 9780593188712)</li>-->
                                                        
                                                        <li><strong>Edition: </strong> First edition</li>
                                                        <li><strong>Series: </strong> Wool #1</li>
                                                        
                                                        <li><strong>Published: </strong> July 30th 2011 by Broad Reach</li>
                                                        <li><strong>Length: </strong> 594 pages.</li>
                                            <li><strong>Language: </strong>English</li>
                                            <li><strong>Genre: </strong> Science fiction, Dystopian fiction, Apocalyptic fiction</li>
                                                    </ul>
                                                </header>
                                        ...
                                        <p><strong>Summary:</strong> Thousands of them have lived underground. They've lived there so long, there are only legends about people living anywhere else. Such a life requires rules. Strict rules. There are things that must not be discussed. Like going outside. Never mention you might like going outside.

Or you'll get what you wish for.</p>
